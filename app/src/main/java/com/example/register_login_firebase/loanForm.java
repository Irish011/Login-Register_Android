...
public class loanForm extends Fragment {
    ...
    EditText bank_nameLoan, Branch_nameLoan, loan_amountLoan, loan_EMILoan, RoiLoan,
            loan_account_numberLoan, disbursement_dateLoan, end_dateLoan, RemarkLoan;
    Button Reset, Submit;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String fbank_nameLoan = bank_nameLoan.getText().toString().trim();
                String fbranch_nameLoan = Branch_nameLoan.getText().toString().trim();
                String fdisbursement_dateLoan = disbursement_dateLoan.getText().toString().trim();
                String fend_dateLoan = end_dateLoan.getText().toString().trim();
                String floan_amountLoan = loan_amountLoan.getText().toString().trim();
                String floan_account_numberLoan = loan_account_numberLoan.getText().toString().trim();
                String floan_EMILoan = loan_EMILoan.getText().toString().trim();
                String fRoiLoan = RoiLoan.getText().toString().trim();
                String fremarkLoan = RemarkLoan.getText().toString().trim();

                CollectionReference dbUserLoan = db.collection("user");
                ...
                UserLoan userloan=new UserLoan(
                        ...
                        fend_dateLoan,
                        fremarkLoan,
                        Integer.parseInt(floan_amountLoan),
                        Integer.parseInt(floan_account_numberLoan),
                        Integer.parseInt(floan_EMILoan),
                        Integer.parseInt(fRoiLoan)
                );

                dbUserLoan.add(userloan)
